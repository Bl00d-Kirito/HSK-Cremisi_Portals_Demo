...
class PokeBattle_Scene
  ...
  def partyAnimationUpdate
    ...
    if @partyAnimPhase==0
      ...
      @sprites["partybarplayer"].x-=16 if @sprites["partybarfoe"]
      if @sprites["partybarfoe"].x+@sprites["partybarfoe"].bitmap.width>=PokeBattle_SceneConstants::FOEPARTYBAR_X
        @sprites["partybarfoe"].x=PokeBattle_SceneConstants::FOEPARTYBAR_X-@sprites["partybarfoe"].bitmap.width if @sprites["partybarfoe"]
