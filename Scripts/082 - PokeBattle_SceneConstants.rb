module PokeBattle_SceneConstants
  ...
  MESSAGESHADOWCOLOR      = Color.new(160,160,168,0)
  ...
  HPCOLORGREENDARK    = Color.new(4,192,32) #0,144,0
  HPCOLORYELLOW       = Color.new(248,176,0)
  HPCOLORYELLOWDARK   = Color.new(248,176,0) #176,104,8
  HPCOLORRED          = Color.new(248,88,40)
  HPCOLORREDDARK      = Color.new(248,88,40) #168,48,56

  # Exp bar colors
  EXPCOLORBASE       = Color.new(72,144,248)
  EXPCOLORSHADOW     = Color.new(72,144,248) #48,96,216
  ...
  PLAYERBOX_X   = Graphics.width - 353
