...
class PokemonSystem
  ...
  def initialize
    ...
    @language    = 0   # Language (see also LANGUAGES in script PokemonSystem)
		@shadow      = 0	 # Enable Shadow (0=disabled, 1=enabled)
  end
end
...
class PokemonOptionScene
 ...
 def pbStartScene
    ...
    @PokemonOptions=[
       ...
       EnumOption.new(_INTL("Font Style"),[_INTL("Roboto"),_INTL("SAO"),_INTL("FRLG"),_INTL("DP")],
          ...
          proc {|value|  
			...
			EnumOption.new(_INTL("Shadow"),[_INTL("Disabled"),_INTL("Enabled")],
          proc { $PokemonSystem.shadow },
          proc {|value|  
					$PokemonSystem.shadow=value
          }
			),
